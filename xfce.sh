...
sudo apt install xfce4 xfce4-goodies xfce4-terminal exo-utils tigervnc-standalone-server tigervnc-common tigervnc-tools dbus-x11 ffmpeg language-pack-en --no-install-recommends -y
...
wget https://raw.githubusercontent.com/vinayhr01/termux-ubuntu/master/ubchromiumfix.sh && chmod +x ubchromiumfix.sh
