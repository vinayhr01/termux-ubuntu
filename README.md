...
```bash
pkg install wget curl proot tar -y && wget https://raw.githubusercontent.com/vinayhr01/termux-ubuntu/master/ubuntu.sh && chmod +x ubuntu.sh && bash ubuntu.sh
```

### Ubuntu 20 CLI Only

```bash
pkg install wget curl proot tar -y && wget https://raw.githubusercontent.com/vinayhr01/termux-ubuntu/master/ubuntu.sh && chmod +x ubuntu.sh && bash ubuntu.sh nde
```

### Ubuntu 20 With LXDE

```bash
pkg install wget curl proot tar -y && wget https://raw.githubusercontent.com/vinayhr01/termux-ubuntu/master/ubuntu.sh && chmod +x ubuntu.sh && bash ubuntu.sh lxde
```
...
```
wget https://raw.githubusercontent.com/vinayhr01/termux-ubuntu/master/librepatch.sh && chmod +x librepatch.sh && bash librepatch.sh
```
